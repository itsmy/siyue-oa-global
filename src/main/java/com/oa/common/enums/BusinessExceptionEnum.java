...
import com.oa.common.exception.*;
...
public enum BusinessExceptionEnum {
    ...
    //数据未找到
    NOT_FOUND(DataNotFoundException.class, HttpStatus.NOT_FOUND, ResultCode.RESUME_DATA_NONE),
    //数据已存在
    CONFLICT(DataConflictException.class, HttpStatus.CONFLICT, ResultCode.DATA_ALREADY_EXISTED),
    //用户未登录
    UNAUTHORIZED(UserNotLoginException.class, HttpStatus.UNAUTHORIZED, ResultCode.USER_NOT_LOG_IN),
    //无访问权限
    ...
    //系统内部错误
    INTERNAL_SERVER_ERROR(InternalServerException.class, HttpStatus.INTERNAL_SERVER_ERROR, ResultCode.INTERFACE_INNER_INVOKE_ERROR);
